...
CCADMIN=CCadmin
RANLIB=ranlib
SVN_REVISION=V1-r$(shell svn up | awk '{print $$3}' | sed 's/\.*$$//g')
YEAR=$(shell date +%Y)
COMPILEDBY=$(shell whoami)
COMPILEHOST=$(shell cat /etc/hostname)
...
# Add your pre 'build' code here...
	#/bin/rm build/loader.o
	@echo "SVN revision: ${SVN_REVISION}"
	/usr/bin/nasm -w+orphan-labels -f elf32 loader.asm -o build/loader.o
.build-post:
# Add your post 'build' code here...
	kdesudo -c ./preparedisk.sh
